            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12" id="center">              
                        <h1><b>Inclusão de Consultas</b></h1>
                        <br>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">  
                    <br>
                    <h4 id="center"><b>CADASTRO DE NOVA GUIA</b></h4>
                    <br> 
                    <form method="post" 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="fusex">Fusex</label>
                                <input type="varchar" name="fusex" 
                                       class="form-control" 
                                       required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="varchar" name="especialidade"                               
                                       class="form-control" 
                                       >
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="preferencia"> Horário </label>
                                <input type="text" name="preferencia"                               
                                       class="form-control" 
                                       >
                            </div>
                        </div>
